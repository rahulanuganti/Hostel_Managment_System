...
import RegisterAdmin from "./components/Dashboards/AdminDashboard/RegisterAdmin";
import RegisterHostel from "./components/LandingSite/RegisterHostel";
      ...
      <Routes>
        <Route path="/" element={<LandingSite />}>
          ...
          <Route path="admin-register" element={<RegisterAdmin />}
            ></Route>
            <Route path="hostel-register" element={<RegisterHostel />}></Route>
